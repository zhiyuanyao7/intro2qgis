...
Add a new connection for XYZ Tile
{: .text-center}
...
Add Google Strees as the basemap
{: .text-center}
...
Drag Googel Streets to the Canvas
{: .text-center}
