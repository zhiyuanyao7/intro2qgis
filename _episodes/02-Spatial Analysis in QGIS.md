...
2. Price is less than $1300. According to a study, a distance of 0.25 miles is often used as an accepted in U.S. research studies. We set 400 meters as the walking distance to make buffers around apartments. 
...
1. make 400 meters distance buffers centered at apartments
2. count the number of grocery stores with the buffers
3. join the buffer’s attribute to apartments layer
4. select the targeted apartments
