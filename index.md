...
> |**Expected results**| Maps are saved for revew. For this:<br>* Learn to save map projects, and create, export, and save map print layouts.<br> * Add item contents (i.e. maps, text box, legend, north arrow, and scale bars) to compose a print layout, and modify item properties.|
